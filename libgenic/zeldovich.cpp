...
static void density_transfer(PetaPM * pm, int64_t k2, int kpos[3], petapm_complex * value);
static void vel_x_transfer(PetaPM * pm, int64_t k2, int kpos[3], petapm_complex * value);
static void vel_y_transfer(PetaPM * pm, int64_t k2, int kpos[3], petapm_complex * value);
static void vel_z_transfer(PetaPM * pm, int64_t k2, int kpos[3], petapm_complex * value);
static void disp_x_transfer(PetaPM * pm, int64_t k2, int kpos[3], petapm_complex * value);
static void disp_y_transfer(PetaPM * pm, int64_t k2, int kpos[3], petapm_complex * value);
static void disp_z_transfer(PetaPM * pm, int64_t k2, int kpos[3], petapm_complex * value);
...
static void disp_transfer(PetaPM * pm, int64_t k2, int kaxis, petapm_complex * value, int include_growth) {
    if(k2) {
