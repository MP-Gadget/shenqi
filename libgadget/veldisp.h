...
void winds_find_vel_disp(const ActiveParticles * act, const double Time, const double hubble, Cosmology * CP, DriftKickTimes * times, TimeBinMgr * timebinmgr, DomainDecomp * ddecomp);
