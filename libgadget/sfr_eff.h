...
void cooling_and_starformation(ActiveParticles * act, double Time, double dloga, TimeBinMgr * timebinmgr, ForceTree * tree, struct grav_accel_store GravAccel, DomainDecomp * ddecomp, Cosmology *CP, MyFloat * GradRho, RandTable * rnd, FILE * FdSfr);
