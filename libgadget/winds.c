        ...
        LocalTreeWalk * lv)
{
    ...
    double wk = 1.0;
    O->TotalWeight += wk * Part[other].Mass;
        ...
        LocalTreeWalk * lv)
{
    ...
    /* Paranoia*/
    if(Part[other].Type != 0 || Part[other].IsGarbage || Part[other].Swallowed)
        return;
    ...
    double random = get_random_number(I->ID + Part[other].ID, WIND_GET_PRIV(lv->tw)->rnd);
