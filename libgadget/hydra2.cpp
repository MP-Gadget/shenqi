...
class HydroTreeWalk: public TreeWalk<HydroQuery, HydroResult, HydroLocalTreeWalk, HydroPriv> {
    public:
    HydroTreeWalk(const char * const i_ev_label, const ForceTree * const i_tree, const HydroPriv& i_priv) : TreeWalk<HydroQuery, HydroResult, HydroLocalTreeWalk, HydroPriv>(i_ev_label, i_tree, i_priv) {}
